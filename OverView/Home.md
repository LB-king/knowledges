      ...
      灰度发布：
        ...
        3.前端灰度发布的几种方式：
          ...
          3.3.客户端渲染的前端应用
            ...
            工作经历：
            XXX公司：
            中行项目前端负责人，参与需求调研、产品交付，顺利完成项目的一期交付;
            项目首屏优化，通过性能监控工具，提升FP、FCP指标；
            
            从零到一完成知因风度产品，快速完成版本1.0 -> 3.3的迭代，全市场风险一键度量,

            个人专利1件(同义词库)、团队专利2件(知识图谱中集成集团黑名单展示)

            车大大
            HMI车载娱乐系统(人工智能方向)
            参与技术选型Vue2.0(全家桶，门店管理平台前后端分离重构)
            广告机网络不稳定导致订单信息不能及时同步的问题
            解决了大屏项目订单信息不能及时同步的问题,websocket心跳保证长连接
            ...
            项目1：风险数据智能化
              ...
              优化了核心项目的首屏性能，通过性能监控工具，提升了FP、FCP指标
              知识库管理中，页面涉及大量图表，通过研究公司已有的BI系统，实现快速、有效的页面展示，节省80%开发时间
            项目2：北京银行知识图谱
              带领团队完成项目从零到一的建设
            ...
            项目4：广告机(大屏)
              websocket心跳，保证订单的同步问题
              图片压缩，减小资源体积，提升页面速度(20%)
        风险数据智能应用
          提取了公共组件库，组件使用文档，类似element-ui
        智慧营销
          搭建项目脚手架，继承框架全家桶，项目CI/CD.提高开发-测试效率
        HMI车联网系统
          遇到问题是毛刺信号导致canvas画面抖动，通过研究动画相关的库，最终选用TweenMax良好的补间动画效果，实现倒车画面的平滑展现。
        车大大门店系统
        制定前后端分离的架构设计方案，包括项目初始化，本地开发、联调、测试、上线等各个环节。
        基于现有的element-ui，开发公司级别的Vue前端组件库knowlegene-ui，适配公司的风格，并开发了业务组件，极大提升了效率?量化？
